...
@Mod(modid = XauntherFBE.MODID, version = XauntherFBE.VERSION)//guiFactory = XauntherFBE.GUIFACTORY) //Not yet added
public class XauntherFBE
{
	...
	public static final String MODID = "xauntherfbe";
	public static final String VERSION = "1.12.2";
	//public static final String  GUIFACTORY = "xauntherfbe.xfbe70_configuration.MBEGuiFactory"; //Not yed added
	
	// The instance of your mod that Forge uses.  Optional.
	@Mod.Instance(XauntherFBE.MODID)
	public static XauntherFBE instance;
	
	// Says where the client and server 'proxy' code is loaded
	@SidedProxy(clientSide="xauntherfbe.ClientOnlyProxy", serverSide="xauntherfbe.DedicatedServerProxy")
