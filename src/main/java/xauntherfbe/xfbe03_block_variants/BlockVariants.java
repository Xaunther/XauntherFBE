package xauntherfbe.xfbe03_block_variants;
...
public class BlockVariants extends Block 
{
	...
	// the block will render in the CUTOUT layer.
	...
	@Override
	public AxisAlignedBB getCollisionBoundingBox(IBlockState iBlockState, IBlockAccess worldIn, BlockPos pos)
	{
		return NULL_AABB;
	}
	...
	{
		EnumColour enumColour = (EnumColour)iBlockState.getValue(PROPERTYCOLOUR);
